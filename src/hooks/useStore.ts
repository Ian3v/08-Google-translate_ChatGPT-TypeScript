...
const initialState: State = {
  ...
  function reducer(state: State, action:action ){
    ...
    if(type === 'SET_FROM_TEXT'){ //Escrbiendo
      return{
        ...state,
        loading:true,
  ...
  export function useStore(){
    ...
    const [{
      ...
      const setFromLanguage = (payload: FromLanguage)=>{  // HAora q esta tipado el tipo q puede ser payload es limitado o solop uede ser o q tenga FromLageage   |Language o | AytoLanguage
        //! el estado este console tiene el estado anterior, App.tsx tiene el actual
